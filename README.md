...
##New Features In This Fork
 ...
 - line,bar and overlay charts have a new option called `labelLenght`. This is a number,which if greater than 0, will trim x-axis labels to a specific length [http://fiddle.jshell.net/leighking2/vepoxa54/](http://fiddle.jshell.net/leighking2/vepoxa54/)
